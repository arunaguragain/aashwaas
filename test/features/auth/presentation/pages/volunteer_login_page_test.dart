...
void main() {
  ...
  Widget createTestWidget() {
    return ProviderScope(
      ...
      child: const MaterialApp(home: VolunteerLoginScreen()),
    );
  }

  group('VolunteerLoginPage - UI Elements', () {
    ...
    testWidgets('should display login as donor link', (tester) async {
      await tester.pumpWidget(createTestWidget());
      await tester.pump();
  ...
  group('VolunteerLoginPage - Form Validation', () {
  ...
  group('VolunteerLoginPage - Form Submission', () {
    testWidgets('should call login usecase when form is valid', (tester) async {
      // Arrange 
      final completer = Completer<Either<Failure, VolunteerAuthEntity>>();
      ...
      // Verify login usecase was called with any params

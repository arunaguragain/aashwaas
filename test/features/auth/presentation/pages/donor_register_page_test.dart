...
void main() {
  ...
  group('DonorRegisterPage - UI Elements', () {
  ...
  group('DonorRegisterPage - Form Input', () {
    testWidgets('should allow entering full name', (tester) async {
      ...
      expect(find.text('Aruna Guragain'), findsOneWidget);
    });
  ...
  group('DonorRegisterPage - Form Validation', () {
    ...
    testWidgets('should not show error when all fields are valid', (
      ...
      // No validation errors for properly filled form
  ...
  group('DonorRegisterPage - Form Submission', () {
